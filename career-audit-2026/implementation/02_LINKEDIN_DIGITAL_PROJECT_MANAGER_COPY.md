...
**Digital Project Manager | Digital Production | AI-Enabled Workflows | Cross-functional Delivery**

This is the default. Do not prepend `AI`, `Transformation`, `Innovation` or `Creative Technology` to the role.

## Alternative vacancy-specific headline

For digital-content / marketing-operations vacancies:

**Digital Project Manager | Digital Content & Production | AI-Enabled Workflows | Cross-functional Delivery**

Use only if the target vacancy is strongly content / production oriented.

---

## About — recommended English version
...
## Current Experience — Accenture Marketing Operations

### Display title

Keep the real employment title visible:
...
- Design and facilitate stakeholder workshops to diagnose issues, align priorities and translate findings into actionable next steps.
...
- Support GenAI adoption through the GenAI Hub and practical enablement, including AI-assisted production workflows and ComfyUI training.

---

## Accenture Song / Fjord / Interactive

### Title

**UX/UI Designer | XR Expert | Digital Experience**

### Description

- Delivered immersive and digital-experience projects for international clients, including realtime showroom environments, XR/AR experiences, UX/UI and product communication.
- Collaborated across design, technology and digital production in international, high-demand delivery environments.
...
**Founder | Digital Studio Director**
...
Prioritize / pin the skills that reinforce recruiter search for the chosen family:
...
## Recruiter five-second test after implementation
